        ...
        <section class="content animated fadeInRight">
            <div class="box-group" id="accordion">
                <div class="panel" style="border: none">
                    <div class="box-body">
                        <form method="post" action="{{ route('deductionsetpostupdate') }}">
                            @csrf
                            ...
                            <div class="form-group row" style="margin-left: 10px">
                                <div class="col-md-4">
                                    <h4 label class="control-label"><b>Deduction Code & Title</b></h4>
                                </div>
                                <div class="col-md-4">
                            ...
                            @foreach($deductions as $value)
                                <div class="row" style="margin-left: 10px">
                                    <div class="col-md-4">
                                        <input type="text" name="dataname<?=$i?>" class="form-control inputnumber" value="{{ $value->deductioncode}}=> {{ $value->deductiontitle }}" readonly>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            @endforeach --}}
                            <div class="col-md-4">
                                <input type="text" name="dataname1" class="form-control inputnumber" value="D-101=> GPF" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper1" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname2" class="form-control inputnumber" value="D-102=> CPF Contrib" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper2" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname3" class="form-control inputnumber" value="D-103=> CPF Subscrptn" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper3" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname4" class="form-control inputnumber" value="D-104=> Pention" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper4" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname5" class="form-control inputnumber" value="D-105=> Welfare Fund" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper5" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname6" class="form-control inputnumber" value="D-106=> Group Insurance" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper6" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname7" class="form-control inputnumber" value="D-107=> Fuel" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper7" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname8" class="form-control inputnumber" value="D-108=> Car Rent" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper8" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname9" class="form-control inputnumber" value="D-109=> Motorcycle Adv." readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper9" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname10" class="form-control inputnumber" value="D-110=> House Bldg Adv." readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper10" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname11" class="form-control inputnumber" value="D-111=> House Rent" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper11" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname12" class="form-control inputnumber" value="D-112=> GPF Loan" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper12" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname13" class="form-control inputnumber" value="D-113=> CPF Loan" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper13" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname14" class="form-control inputnumber" value="D-114=> Comp. Loan" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper14" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname15" class="form-control inputnumber" value="D-115=> Telephone Bill" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper15" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname16" class="form-control inputnumber" value="D-116=> Gas Bill" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper16" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname17" class="form-control inputnumber" value="D-117=> Electric Bill" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper17" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname18" class="form-control inputnumber" value="D-118=> WASA Bill" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper18" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname19" class="form-control inputnumber" value="D-119=> Ctax" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper19" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname20" class="form-control inputnumber" value="D-120=> Sal Income Tax" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper20" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname21" class="form-control inputnumber" value="D-121=> Other Deduction" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper21" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname22" class="form-control inputnumber" value="D-122=> Vehicle Loan for Privileged Officer" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="number" name="amporper22" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                                                                    ...
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname23" class="form-control inputnumber" value="D-123=> Welfare Fund Loan" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select name="apstatus23" class="form-control inputnumber">
                                        <option value="">Select Type</option>
                                        <option value="Amount">Amount</option>
                                        <option value="Percentage">Percentage</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="number" name="amporper23" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                </div>
                            </div>
                        </div>
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname24" class="form-control inputnumber" value="D-124=> Revenue Stamp" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select name="apstatus24" class="form-control inputnumber">
                                        <option value="">Select Type</option>
                                        <option value="Amount">Amount</option>
                                        <option value="Percentage">Percentage</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="number" name="amporper24" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                </div>
                            </div>
                        </div>
                                                                                    <div class="row" style="margin-left: 10px">
                            <div class="col-md-4">
                                <input type="text" name="dataname25" class="form-control inputnumber" value="D-125=> Service Charge" readonly>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select name="apstatus25" class="form-control inputnumber">
                                        <option value="">Select Type</option>
                                        <option value="Amount">Amount</option>
                                        <option value="Percentage">Percentage</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="number" name="amporper25" class="form-control inputnumber"
                                        placeholder="Enter Amount or Percentage">
                                </div>
                            </div>
                        </div>
